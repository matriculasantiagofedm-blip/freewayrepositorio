            ...
            <div className="w-[10.5in] h-[8in] p-8 bg-white text-black font-serif mx-auto print:m-0 print:p-8 relative">
                <div className="w-full h-full border-[3px] border-black flex flex-col p-8 relative">
                    ...
                    <header className="flex w-full flex-col items-center justify-center relative pt-2">
                        <h2 className="text-[9pt] font-bold tracking-tight mb-1 uppercase">FREEWAY ESCUELA DE MANEJO S.A.</h2>
                        <h1 className="text-[26pt] font-black tracking-[0.15em] leading-none mb-1 text-black">FREEWAY</h1>
                        <p className="text-[11pt] tracking-[0.4em] font-semibold text-black uppercase">Escuela de Manejo</p>
                        <p className="text-[9pt] italic mt-1">Casa Matriz Chorrera</p>

                        <div className="absolute top-0 right-0 text-center">
                            <p className="text-[20pt] font-black mb-1">{getHighestLicenseType(certificate.licenseType)}</p>
                    ...
                    <main className="flex-grow flex flex-col items-center justify-center text-center px-12 mt-1">
                        <p className="text-[9pt] uppercase tracking-[0.2em] mb-4 font-medium">Otorga el presente Certificado a:</p>

                        <div className="mb-4 w-full">
                            <p className="font-black text-[18pt] tracking-tighter leading-none mb-2 uppercase border-b-2 border-black/10 pb-1">
                                {certificate.clientName}
                            </p>
                            <p className="font-bold text-[15pt] tracking-widest">{certificate.idType || 'C.I.P.'} &nbsp; {certificate.cip}</p>
                        </div>

                        <div className="text-[11pt] leading-relaxed max-w-4xl mx-auto py-2 px-6 border-2 border-dashed border-black/10 rounded-lg">
                            <p>
                        ...
                        <div className="text-[8pt] mx-auto mt-4 max-w-2xl font-bold opacity-80">
                            <p>
                                Reconocida por la Autoridad del Tránsito y Transporte Terrestre, Resuelto N°380 (04 de diciembre de 2000) Resolución AL-325
                            </p>
                        </div>
                        
                        <div className="text-center mt-3 font-bold text-[6pt] italic">
                    ...
                    <footer className="w-full flex justify-end pt-1 pr-12 pb-1">
                        <div className="text-center w-64">
                            ...
                            <p className="text-[9pt] italic font-bold">Lic. Ayax Ortega</p>
                            <p className="text-[7pt] uppercase font-black tracking-widest opacity-60">Representante Legal</p>
                        </div>
                    </footer>
                </div>
            </div>
...
function CertificateBackAmpliacion({ certificate }: { certificate: Certificate }) {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-white print:block print:h-auto">
            <div className="w-[10.5in] h-[8in] p-16 bg-white text-black font-sans text-[12pt] flex flex-col justify-start mx-auto print:m-0 print:p-16">
                    ...
                    <div className="pt-10 space-y-6 mt-8">
                        <div className="flex gap-x-12">
                            <div className="flex flex-col gap-1 flex-1">
                                <span className="text-[7pt] font-black uppercase text-slate-400">Primer Nombre</span>
                                <span className="font-black text-[14pt]">{certificate.firstName?.toUpperCase() || ''}</span>
                            </div>
                            <div className="flex flex-col gap-1 flex-1">
                                <span className="text-[7pt] font-black uppercase text-slate-400">Segundo Nombre</span>
                                <span className="font-black text-[14pt]">{certificate.middleName?.toUpperCase() || ''}</span>
                            </div>
                        </div>
                        <div className="flex gap-x-12">
                            <div className="flex flex-col gap-1 flex-1">
                                <span className="text-[7pt] font-black uppercase text-slate-400">Primer Apellido</span>
                                <span className="font-black text-[14pt]">{certificate.lastName?.toUpperCase() || ''}</span>
                            </div>
                            <div className="flex flex-col gap-1 flex-1">
                                <span className="text-[7pt] font-black uppercase text-slate-400">Segundo Apellido</span>
                                <span className="font-black text-[14pt]">{certificate.secondLastName?.toUpperCase() || ''}</span>
                            </div>
                        </div>
                    </div>
                </div>
