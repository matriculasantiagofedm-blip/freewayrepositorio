    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-muted-foreground uppercase">Auditoría global de folios impresos.</p>
          </div>
        </div>
        <Popover>
      ...
      <Card className="shadow-sm border-slate-200">
        <CardHeader className="py-3 px-6 bg-slate-50/50 border-b flex flex-row items-center justify-between">
          <CardTitle className="text-[10px] font-black uppercase tracking-widest text-slate-500">Documentos Emitidos</CardTitle>
          <span className="bg-indigo-100 text-indigo-800 text-[10px] font-black px-2 py-0.5 rounded uppercase">Recuento: {contracts?.length || 0}</span>
        </CardHeader>
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50">
                  <TableHead className="text-[10px] font-black uppercase">Folio Físico</TableHead>
                  <TableHead className="text-[10px] font-black uppercase">Estudiante</TableHead>
                  <TableHead className="text-[10px] font-black uppercase">Identificación</TableHead>
                  <TableHead className="text-[10px] font-black uppercase">Categoría</TableHead>
                  <TableHead className="text-[10px] font-black uppercase">Hora Emisión</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {contracts.map((c) => (
            ...
            <div className="p-12 text-center text-xs font-bold text-slate-400 italic">No se reportan impresiones para este día.</div>
          )}
        </CardContent>
      </Card>
    </div>
