 ...
 * Se aumentó el texto un 25% y se simplificó la estructura CSS.
 */
...
function CertificateFront({ certificate }: { certificate: Certificate }) {
    ...
    return (
        <div className="certificate-page-container print:m-0 print:p-0">
            <div className="w-[11in] h-[8.5in] bg-white text-black font-serif relative flex items-center justify-center overflow-hidden break-after-page">
                <div className="w-[10.2in] h-[7.8in] border-[3px] border-black flex flex-col p-10 relative bg-white">
                    ...
                    <header className="flex w-full flex-col items-center justify-center relative pt-2">
                        <h2 className="text-[12.5pt] font-bold tracking-tight mb-1 uppercase">FREEWAY ESCUELA DE MANEJO S.A.</h2>
                        <h1 className="text-[44pt] font-black tracking-[0.12em] leading-none mb-1 text-black">FREEWAY</h1>
                        <p className="text-[16pt] tracking-[0.3em] font-semibold text-black uppercase">Escuela de Manejo</p>
                        <p className="text-[12.5pt] italic mt-1">Casa Matriz Chorrera</p>

                        <div className="absolute top-0 right-0 text-center">
                            <p className="text-[28pt] font-black mb-1">{getHighestLicenseType(certificate.licenseType)}</p>
                    ...
                    <main className="flex-grow flex flex-col items-center justify-center text-center px-12">
                        <p className="text-[12.5pt] uppercase tracking-[0.15em] mb-6 font-medium">Otorga el presente Certificado a:</p>

                        <div className="mb-6 w-full">
                            <p className="font-black text-[25pt] tracking-tighter leading-none mb-3 uppercase">
                                {certificate.clientName}
                            </p>
                            <p className="font-bold text-[20pt] tracking-widest">{certificate.idType || 'C.I.P.'} &nbsp; {certificate.cip}</p>
                        </div>

                        <div className="text-[16pt] leading-relaxed max-w-3xl mx-auto">
                            <p>
                        ...
                        <div className="text-[11pt] mx-auto mt-8 max-w-2xl font-bold opacity-90">
                            <p>
                    ...
                    <footer className="w-full flex justify-end pr-12 pb-4">
                        <div className="text-center w-48">
                            ...
                            <p className="text-[12.5pt] italic font-bold">Lic. Ayax Ortega</p>
                            <p className="text-[10pt] uppercase font-black tracking-widest opacity-70">Representante Legal</p>
                        </div>
                    </footer>
                </div>
            </div>
    ...
    return (
        <div className="certificate-page-container print:m-0 print:p-0">
            <div className="w-[11in] h-[8.5in] bg-white text-black font-sans relative flex items-center justify-center p-0 overflow-hidden">
                <div className="w-[10.5in] h-[8in] p-20 flex flex-col justify-center bg-white text-[17.5pt] leading-relaxed">
                    <div className="space-y-8 w-full">
                        ...
                        <p><span className="font-bold uppercase tracking-widest text-[20pt]">TIPO DE LICENCIAS:</span> <span className="font-black">{certificate.licenseType}</span></p>
                        ...
                        <div className="pt-12 space-y-10">
                            <div className="flex gap-x-16">
                                <div className="flex flex-col gap-1 flex-1">
                                    ...
                                    <span className="font-black text-[22.5pt] border-b border-slate-100 pb-1">{certificate.firstName?.toUpperCase() || ''}</span>
                                </div>
                                <div className="flex flex-col gap-1 flex-1">
                                    <span className="text-[11pt] font-black uppercase text-slate-400">Segundo Nombre</span>
                                    <span className="font-black text-[22.5pt] border-b border-slate-100 pb-1">{certificate.middleName?.toUpperCase() || ''}</span>
                                </div>
                            </div>
                            <div className="flex gap-x-16">
                                <div className="flex flex-col gap-1 flex-1">
                                    <span className="text-[11pt] font-black uppercase text-slate-400">Primer Apellido</span>
                                    <span className="font-black text-[22.5pt] border-b border-slate-100 pb-1">{certificate.lastName?.toUpperCase() || ''}</span>
                                </div>
                                <div className="flex flex-col gap-1 flex-1">
                                    <span className="text-[11pt] font-black uppercase text-slate-400">Segundo Apellido</span>
                                    <span className="font-black text-[22.5pt] border-b border-slate-100 pb-1">{certificate.secondLastName?.toUpperCase() || ''}</span>
                                </div>
                            </div>
                        </div>
                    </div>
