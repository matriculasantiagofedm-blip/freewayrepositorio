...
export const CHANNELS = [
  ...
  { id: 'internal_ventas', label: 'Solo Ventas (Interno)', roles: ['Ventas'], color: 'bg-blue-500' },
  { id: 'internal_ventasext', label: 'Solo Ventas Ext (Interno)', roles: ['Ventas Externas'], color: 'bg-purple-500' },
];
