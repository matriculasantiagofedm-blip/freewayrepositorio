    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight">Agenda por Vehículo</h1>
            <p className="text-xs font-bold text-muted-foreground uppercase">Control de ocupación de flota diaria.</p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-6 p-4 bg-slate-50 rounded-xl border border-dashed text-[9px] font-bold uppercase text-slate-500">
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-blue-50 border border-blue-200 rounded"></div> Contrato Web/Admin</div>
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-amber-50 border border-amber-200 rounded"></div> Asignación Manual</div>
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-red-600 rounded"></div> Inasistencia</div>
        <div className="ml-auto flex items-center gap-2"><Info className="h-3 w-3" /> Máximo 3 alumnos por turno global (Regla de Tránsito)</div>
      </div>
    </div>
  );
}
