  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <Card className="animate-in fade-in-50 max-w-2xl mx-auto w-full">
            ...
            <CardContent className="space-y-6">
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                   <div className="space-y-2">
                      <Label htmlFor="client-name">Nombre Completo del Cliente</Label>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="student-id">Cédula del Cliente</Label>
            ...
            <CardFooter>
                {!paymentSaved ? (
                    <Button onClick={handleSaveSale} disabled={isSaving || !selectedBook || !clientName || !studentIdNumber}>
