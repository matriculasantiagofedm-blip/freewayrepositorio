...
export function DeluxePremiumContractTemplatePreview({ clientName, clientEmail, deluxeDetails }: DeluxePremiumContractTemplatePreviewProps) {
  ...
  return (
    <Card className="p-6 print:shadow-none print:border-none print:p-0 font-serif text-xs">
      <CardContent className="p-0 space-y-2">
        ...
        <h3 className="font-bold text-sm">CLÁUSULA PRIMERA - OBJETO DEL CONTRATO</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA TERCERA - DETALLES DEL CURSO</h3>
        ...
        <p className="font-semibold text-primary">Clases teóricas: Miércoles, de 6:00 p.m. a 8:00 p.m.</p>
        <div className="grid grid-cols-3 gap-x-4 gap-y-0.5 text-[11px]">
          <span>Semana 1: <Line className="min-w-20" /></span>
          <span>Semana 2: <Line className="min-w-20" /></span>
          <span>Semana 3: <Line className="min-w-20" /></span>
          <span>Semana 4: <Line className="min-w-20" /></span>
          <span>Semana 5: <Line className="min-w-20" /></span>
          <span>Semana 6: <Line className="min-w-20" /></span>
          <span>Semana 7: <Line className="min-w-20" /></span>
          <span>Semana 8: <Line className="min-w-20" /></span>
          <span>Semana 9: <Line className="min-w-20" /></span>
          <span>Semana 10: <Line className="min-w-20" /></span>
        </div>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA QUINTA - POLÍTICA DE PAGOS Y MOROSIDAD</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA SEXTA- INASISTENCIAS Y REPROGRAMACIONES</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA SEPTIMA - PUNTUALIDAD</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA OCTAVA- LUGAR DE INICIO Y TRASLADO</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA NOVENA - NORMAS DE COMPORTAMIENTO Y VESTIMENTA</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA DÉCIMA- ACOMPAñANTES Y ACCESO</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA DÉCIMA PRIMERA- CONDICIONES DE APTITUD</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA DÉCIMA SEGUNDA - CANCELACIÓN DEL CONTRATO</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA DÉCIMA TERCERA - CERTIFICACIÓN</h3>
        ...
        <h3 className="font-bold text-sm">CLÁUSULA DÉCIMA CUARTA- VIGENCIA DEL CURSO</h3>
        ...
        <p className="text-center">
            En fe de lo cual, se suscribe el presente contrato en la ciudad de Panamá, República de panamá, a los {format(currentDate, 'd')} días del mes de {format(currentDate, 'LLLL', { locale: es })}, de {format(currentDate, 'yyyy')}, a las {format(currentDate, 'HH:mm')}.
        </p>
